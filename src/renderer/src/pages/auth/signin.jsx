  ...
  const buttonClick = async () => {
    if (signUpUI) {
      if (inputs.password != inputs.confirmPassword) {
        setShowError({ show: true, message: 'Passwords Did not match' })
        return
      }
      ...
      if (!response.success) {
        ...
        pushNotification('Sign Up Successfully!!', '')
      }
    } else {
      setBtnLoading(true)
      ...
      pushNotification('Sign In Successfully!!', '')
    }
  }
  ...
  return (
    <div className="flex flex-col items-center h-screen justify-center">
      <div className="flex flex-col items-center">
          ...
          <>
            ...
            <div className="flex flex-col mt-5">
              ...
              <input
                ...
                className="bg-input-bg p-2 w-72 rounded-md outline-none"
                onChange={(val) => {
                  setInputs({ ...inputs, password: val.target.value })
                }}
              />
            </div>
            <div className="flex flex-col mt-5">
              ...
              <input
                ...
                className="bg-input-bg p-2 w-72 rounded-md outline-none"
                onChange={(val) => {
                  setInputs({ ...inputs, confirmPassword: val.target.value })
                }}
              />
            </div>
          </>
        ...
        {showError.show && (
          <span className="mt-1 text-[#f94a6a] capitalize">{showError.message}</span>
        )}
        <div className="mt-6">
